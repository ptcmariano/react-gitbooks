...
/***/ function(module, exports, __webpack_require__) {
	...
	var _booksContainer = __webpack_require__(251);
	...
	_reactDom2['default'].render(_react2['default'].createElement(
	    ...
	    _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(_reactRouter.Route, { path: '/books', component: _booksContainer2['default'] })
	        )
	    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _book = __webpack_require__(248);
...
/***/ function(module, exports) {
	...
	exports['default'] = function () {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? bookInitialState : arguments[0];
	    var action = arguments[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _books = __webpack_require__(252);
	...
	var bookContainer = _react2['default'].createClass({
	    ...
	    render: function () {
	        function render() {
	            ...
	            // )
	            return _react2['default'].createElement('books', this.props);
	        }
	...
	exports['default'] = (0, _reactRedux.connect)(stateToProps, dispatchToProps)(bookContainer);
	        ...
	        function render() {
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    "ul",
	                    null,
	                    this.props.users.map(function (book, i) {
	                        return _react2["default"].createElement(
	                            "li",
	                            { key: book.id, onClick: _this.props.onClick },
	                            book.name
	                        );
	                    })
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getbooks() {
	    return _axios2['default'].get('https://api.gitbook.com/books/all?limit=10').then(function (response) {
